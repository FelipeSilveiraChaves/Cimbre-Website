      ...
      <div className="max-w-145">
        ...
        <div className="text-carbon-800 mt-10 flex flex-col gap-[29.2px] text-xl/[29.2px]">
          ...
          <p>
            ...
            incluindo páginas de produtos, artigos e materiais informativos.
            Esses links são fornecidos apenas como referência e conveniência.
            Não temos controle sobre o conteúdo de sites de terceiros e não nos
            responsabilizamos por informações, políticas, produtos ou serviços
            oferecidos fora do domínio cimbre.com.br. O usuário é incentivado a
            verificar os termos e políticas dos sites acessados por meio de
            links externos.
          </p>
          <p>
            Os conteúdos publicados no site têm finalidade exclusivamente
            informativa e educacional, não constituindo aconselhamento
            profissional de qualquer natureza, incluindo consultoria jurídica,
            financeira, médica ou psicológica. Cada usuário é responsável pela
            forma como interpreta e aplica as informações fornecidas,
            reconhecendo que resultados podem variar de acordo com sua
            realidade, contexto e dedicação individual.
          </p>
          <p>
            Reservamo-nos o direito de modificar estes Termos de Uso a qualquer
            momento, sempre que houver necessidade de atualização do site,
            ajustes legais ou alteração nas estratégias de comunicação e
            comercialização. O uso contínuo do site após modificações representa
